      ...
      <form method="POST" accept-charset="utf-8"> 
       <div id="box1" style="width: 550px;" >   
           ...
           <?php     } ?>
            ...
            <div class="form-group col-md-3"  style="width: 450px;">
                            <?php if ($featchselect["status_leave"]==-2){?>
                <i class="fas fa-check"></i>
           <?php     } ?>
       ...
       <div id="box1"  style="" >   
           ...
           <?php     } ?>
            ...
            <div class="form-group "  style="width: 450px;">
                ...
                <i class="fas fa-check"></i>
           <?php     } ?>
                   <button class="btn btn-danger" name="cancel_sus" id="cancel_sus" onclick="del(<?=$_GET["id"]?>
                       ,<?=$_GET["emp"]?>
                       ,<?=$_GET["type_id"]?>  )"  value="cancel_sus"><i class="fas fa-ban"></i>ยกเลิกการลา</button>   
            </div>
    ...
    <div class="row">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <p class="card-text input_show1" style="margin-right: 30%;"><font>เรียน  ผู้อำนวยการสำนักงานเขตสุขภาพที่ 4</font> </p>
