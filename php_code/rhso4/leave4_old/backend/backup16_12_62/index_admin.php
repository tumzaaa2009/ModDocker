...
if ($_SESSION["Username"]=="navapon.yoi" || $_SESSION["Username"]=="pratoom") {
...
<body x>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">  <a class="navbar-brand" href="#" onclick="index();"><img src="../icon/logo2.png" alt="" width="55px" height="55px">
 <font color="black"> รายงาน และ อนุมัติใบลา</font></a>
 ...
 WHERE type_id =1 AND status_leave in (SELECT status_leave FROM tbl_holiday_detail WHERE status_leave=1 OR status_leave=2)
  ";
          ...
          $num= $feath_num["count"];
                      ...
                      ?>
           <font color="red"><?=$num ?></font><a data-toggle="modal" href="#" data-target="#exampleModal1"> <i class="fas fa-envelope-open-text"  ></i>คลิ๊กเพื่อดูการแจ้งเตือนอนุมัติลา พักร้อน  </a>    
              <!-- Modal 1 -->
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">รอการอนุมัติ ลาพักร้อน</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
       <p><a href="admin_approve_status.php?approve&&type=1&&status=1"><i class="far fa-sticky-note"></i><font size="5" color="red"><?php 
       ...
       echo $num?></font>รอการอนุมัติจากผู้บังคับบัญชา</a></p>
       <p>
        <a href="admin_approve_status.php?approve&&type=1&&status=2"><i class="far fa-sticky-note"></i>
      ...
      echo $num2?></font>รอการอนุมัติจากผู้อำนวยการ</a></p>
      </div>
 ...
 WHERE type_id =2 AND status_leave in (SELECT status_leave FROM tbl_holiday_detail WHERE status_leave=1 OR status_leave=2)
  ";
            ...
            $num2=$feath_num2["count"];
                      ?>
           <font color="red"><?=$num2?></font>  <a data-toggle="modal" data-target="#exampleModal2" href="#"><i class="fas fa-envelope-open-text" onclick="test();" ></i> คลิ๊กเพื่อดูการแจ้งเตือนอนุมัติลา ลาป่วย </a> 
        </div>
              <!-- Modal 2 -->
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <p><a href="admin_approve_status.php?approve&&type=2&&status=1"><i class="far fa-sticky-note"></i><font size="5" color="red"><?php 
  $select_t2 = "SELECT status_leave  FROM tbl_holiday_detail WHERE status_leave =1 AND  type_id=2 " ;
       ...
       echo $numt2; ?></font> รอการอนุมัติจากผู้บังคับบัญชา</a></p>
       <p><a href="admin_approve_status.php?approve&&type=2&&status=2"><i class="far fa-sticky-note"></i>
  ...
  $select_t2_2 = "SELECT status_leave  FROM tbl_holiday_detail WHERE status_leave =2 AND  type_id=2 " ;
       ...
       $numt2_2 = mysqli_num_rows($query_select_t2_2);
        ...
        echo $numt2_2?></font> รอการอนุมัติจากผู้อำนวยการ</a></p>
      </div>
