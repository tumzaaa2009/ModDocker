...
SET fix_count_oldyear_holiday='".$_POST['count_old']."', count_year_holiday='".$_POST['count_year']."',sum_thisyear_holiday = '".$_POST['sum_limit']."' 
...
<body>
 ...
 $select_emp = "SELECT emp.emp_Status,emp.group_id,limithol.Financial_year,emp.Emp_id,gtype.name,emp.Emp_name,emp.Emp_lastname
  ...
  INNER JOIN tbl_group_type gtype ON gtype.group_id=emp.group_id
     $filter_type  $filter_fiscal GROUP BY emp.Emp_id   ORDER BY limithol.Financial_year ASC ,emp.Emp_Status DESC";
...
?>
                        <form method="POST">
                            <tr align="center">
                                ...
                                <td>
                                    <input type="text" name="sum_limit"  id="sum_limit<?=$count?>"
                                        class="form-control"   value="<?=$row_empedit['sum_thisyear_holiday']?>">
                                </td>
                                <td>
