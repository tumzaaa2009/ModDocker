...
$select = "SELECT *,gtype.name AS gname,psgroup.name AS pname ,thoildiay.type_name ,(CAST(detail.hoilday_detail_id AS UNSIGNED)) iddesc FROM tbl_employment AS emp INNER JOIN tbl_holiday_detail as detail  ON emp.Emp_id = detail.Emp_id
