...
and  detail.type_id='".$_GET["type_id"]."'";
    ...
    <nav aria-label="breadcrumb" id="non-printable">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item "> <a href="../backend/index_admin.php"
            ...
            <div class="row">
               ...
               echo "(เนื่องจาก".$featchselect["cancle_approvesusecc_comment"].")";
                                    ...
                                    <p class="card-text input_show1"
                                        style="margin-left: 5%;margin-bottom: -10px;margin-top: -10px;">
                                         ...
                                         $num_query_group= 1;
                                          while ($featch_query_group=mysqli_fetch_array($query_group)) {
                                                $checkboxtype="checkboxtype".$num_query_group;
                                                      $num_query_group++;
                                           ?>
                                        <font style="margin-left: 1%"><input type="checkbox" name="checkboxtype"
                                                id="<?=$checkboxtype?>" disabled
                                                value="<?=$featch_query_group["group_id"]?>">
                                            <?=$featch_query_group["name"]?></font>
                                        <?php }?>
                                    </p>

                                    <p class="card-text ">
                                        <font style="margin-left: 3.2%;"> <input class="form-check-input"
                                                type="checkbox" name="check_leave" value="ป่วย" id="sick_1">ป่วย
                                        </font>
                                        <font style="margin-left: 11%;">
                                            เนื่องจาก <input type="text" class="input_show2" disabled="true"
                                                id="to_leave1" name="To_leave_1" disabled="true"
                                                style="width: 50%;font-size: 20px;padding-left: 25px;">
                                        </font>
                                    </p>
                                    <p class="card-text ">
                                        <font style="margin-left: 3.2%;"> <input class="form-check-input"
                                                type="checkbox" disabled="true" name="check_leave"
                                                value="ขอลากิจส่วนตัว" id="sick_2">ขอลากิจส่วนตัว
                                        </font>
                                        <font style="margin-left: 1%;">
                                            เนื่องจาก <input type="text" class="input_show2" disabled="true"
                                                id="to_leave2" name="To_leave"
                                                style="width: 50%;font-size: 20px;padding-left: 25px;">
                                        </font>
                                    </p>
                                    <p class="card-text ">
                                        <font style="margin-left: 3.2%;"> <input class="form-check-input"
                                                type="checkbox" name="check_leave" value="คลอดบุตร" id="sick_3"
                                                disabled="true">คลอดบุตร
                                        </font>
                                    </p>
             ...
             ?>
                                ...
                                <p class="card-text " style="margin-left:1.5%">
                                    ...
                                    <font style="margin-left: 3.2%;"> <input class="form-check-input" type="checkbox"
                                            name="check_leave" value="ป่วย" id="sick_1_1">ป่วย
                                    </font>
                                    <font style="margin-left: 3.2%;"> <input class="form-check-input" type="checkbox"
                                            disabled="true" name="check_leave" value="ขอลากิจส่วนตัว"
                                            id="sick_2_1">ขอลากิจส่วนตัว
                                    </font>
                                    <font style="margin-left: 3.2%;"> <input class="form-check-input" type="checkbox"
                                            disabled="true" name="check_leave" value="ขอลากิจส่วนตัว"
                                            id="sick_3_1">คลอดบุตร
                                    </font>
                                        ...
                                        <div class="col-6">
                                            <p>
                                                <font><b><u>ความเห็นผู้บังคับบัญชา</u></b>
                                                    <font
                                                        style=" border-bottom: 1px dashed #000 ;margin-bottom: 10px;margin-top: 10px;">
                                                        <p><?=$featchselect["approve_comment"]?></p>
                                                    </font>
                                                    <?php if (isset($featchselect["approve_by"])   ) {?>
                                                    <font>(ลงชื่อ).........<?=$featchselect["approve_by"]?>..........
                                                    </font>
                                                    <?php }else{?> <font>
                                                        (ลงชื่อ)................................................</font>
                                                    <?php } ?>
...
echo   "<p style=\"margin-top: -20px;\">วันที่.......................".$newDate."......................</font>";
                                        ...
                                        <div class="col-6">
                                            ...
                                            <p style="width: 100%">
                                                ...
                                                <font style="margin-left:1%;">
                                                    <input type="checkbox" disabled="true" id="disapporve"> ไม่อนุญาต
                                                </font>
                                            </p>
                                            <font style=" border-bottom: 1px dashed #000 ;margin-top: -20px;">
